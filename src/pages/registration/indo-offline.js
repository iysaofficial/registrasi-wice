...
function IndonesiaOffline() {
  ...
  const scriptURL = "https://script.google.com/macros/s/AKfycbzO7qn6MeHUUwDn2-6HURncDBQw9ixtJQyagSes6r3lEC9mxymMsfUZkD2Z24lMM9t6/exec";
        ...
        <div className="container">
          <div className="content">
            ...
            <h4 className="text-xl">
              HALLO PESERTA WICE 2025, Mohon perhatikan informasi berikut ini
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  <label for="INFORMATION_RESOURCES" className="form-label">
                    Sumber Informasi Kompetisi WICE 2025
                  </label>
                  <select
                    type="text"
